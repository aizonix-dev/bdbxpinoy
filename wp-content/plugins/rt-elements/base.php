...
final class RTelements_Elementor_Extension {
	...
	public function init_widgets() {
		...
		if( isset( $rtelements_addon_setting['rt_animated_heading_setting'] ) == 'rselement_animated_heading' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacThemes_Elementor_Animated_Heading_Widget() );
		}	
		
		//Sound Coud 
		require_once( __DIR__ . '/widgets/sound-cloud/sound-cloud.php' );	
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Sound_Cloud_Widget() );
		
		
		//Tab Sound Coud 
		require_once( __DIR__ . '/widgets/tab-sound-cloud/tab-sound-cloud.php' );	
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Tab_Sound_Cloud_Widget() );
		


		//Dual Heading
		require_once( __DIR__ . '/widgets/dual-heading/dual-heading.php' );	
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacThemes_Elementor_Heading_dual_Widget() );

		require_once( __DIR__ . '/widgets/image-about-home/about-image.php' );	
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Quote_Widget() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Image_Showcase_Widget() );		
		}
		...
		if( isset( $rtelements_addon_setting['rt_team_gread_setting'] ) == 'rt_team_gread_setting' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Elementor_Team_Grid_Widget() );
		}
		...
		if( isset( $rtelements_addon_setting['rt_team_slider_setting'] ) == 'rt_team_slider_setting' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTElements_Elementor_Team_Slider_Widget() );
		}
		...
		if( isset( $rtelements_addon_setting['rt_service_grid_setting'] ) == 'rt_service_grid_setting' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Sservices_Grid_Widget() );	
		}
		...
		if( isset( $rtelements_addon_setting['rt_service_slider_setting'] ) == 'rt_service_slider_setting' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Services_Slider_Widget() );
		}

		//Video
		if( isset( $rtelements_addon_setting['rt_video_setting'] ) == 'rt_video_setting' ) {
			require_once( __DIR__ . '/widgets/video/rt-video.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Video_Widget() );
		}

		//Button
		if( isset( $rtelements_addon_setting['rt_button_setting'] ) == 'rt_button_setting' ) {
			require_once( __DIR__ . '/widgets/button/button.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Button_Widget() );
		}
		//Testimonial Slider
		if( isset( $rtelements_addon_setting['rt_testimonial_slider_setting'] ) == 'rt_testimonial_slider_setting' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Slider_Widget() );
		}
        ...
        if( isset( $rtelements_addon_setting['rt_blog_grid_setting'] ) == 'rtelement_blog_grid' ){
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Elementor_Blog_Grid_Widget () );
		}

		if( isset( $rtelements_addon_setting['rt_tab_setting'] ) == 'rtelement_tab' ){
			require_once( __DIR__ . '/widgets/tab/tab.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Tab_Widget() );
		}
		...
		if( isset( $rtelements_addon_setting['rt_counter_setting'] ) == 'rtelement_counter' ){
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Elementor_Counter_Widget() );
		}

		//Contact Form 7
		if( isset( $rtelements_addon_setting['rt_contact_form_7_setting'] ) == 'rs_contact_form_7_setting' ) {
			require_once( __DIR__ . '/widgets/cf7/contact-cf7.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Elementor_CF7_Widget() );
		}
		//Logo Showcase
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacThemes_Logo_Showcase_Widget() );
		}
        ...
        if( isset( $rtelements_addon_setting['rt_blog_slider_setting'] ) == 'rtelement_blog_slider' ){
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Elementor_Blog_Slider_Widget() );
		}
		
		//price table
		if( isset( $rtelements_addon_setting['rt_pricing_table_setting'] ) == 'rselement_pricing_table' ) {
			require_once( __DIR__ . '/widgets/pricing-table/pricing-table.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Elementor_Pricing_Table_Widget() );
		}
        ...
        if( isset( $rtelements_addon_setting['rt_portfolio_grid_setting'] ) == 'rtelement_portfolio_grid' ){
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Portfolio_Grid_Widget() );
		}
        ...
        if( isset( $rtelements_addon_setting['rt_newsletter_setting'] ) == 'rtelement_newsletter' ){
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Mailchimp_Widget() );
		}
		...
		if( isset( $rtelements_addon_setting['rt_accordion_setting'] ) == 'rt_accordion_setting' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Widget_Accordion() );
		}	
		
		//CTA
		if( isset( $rtelements_addon_setting['rt_cta_setting'] ) == 'rt_cta_setting' ) {				
			require_once( __DIR__ . '/widgets/cta/cta.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_CTA_Widget() );
		}
		
		//Advance Tab
		require_once( __DIR__ . '/widgets/advanced-tab/tab.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacThemes_Advance_Tab_Widget() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Portfolio_Slider_Widget() );
		}
		...
		if( isset( $rtelements_addon_setting['rt_progress_bar_setting'] ) == 'rt_progress_bar_setting' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Progress_Widget() );	
		}	
	

		if( isset( $rtelements_addon_setting['rt_icon_box_setting'] ) == 'rtelement_icon_box' ){
		require_once( __DIR__ . '/widgets/iconbox/rs-iconbox.php' );	
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Icon_Box_Widget() );	
		}	
		if( isset( $rtelements_addon_setting['rt_number_grid_setting'] ) == 'rt_number_grid_setting' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacThemes_Elementor_Numnber_Widgets () );	
		}

		//Progress Pie
		if( isset( $rtelements_addon_setting['rt_progress_pie_setting'] ) == 'rt_progress_pie_setting' ) {
		require_once( __DIR__ . '/widgets/progress-pie/progress-pie.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reacthemes_Elementor_Progress_Pie_Widget() );		
		}
		//countdown
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacThemes_Elementor_Business_Hour_Widget() );
		}
		
		require_once( __DIR__ . '/widgets/image-card/image-card.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Image_Card_Widget() );

		// Marque		
		require_once( __DIR__ . '/widgets/marquee/marquee.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_Marquee_Widget() );		
		
		// Marque Testimonial
		require_once( __DIR__ . '/widgets/marque-testimonial/marque-testimonial.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Marque_Testimonial_Widget() );		

		// Line Draw		
		require_once( __DIR__ . '/widgets/line-draw/line-draw.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Rsaddon_Elementor_pro_Line_Draw_Widget() );		
		...
		if( isset( $rtelements_addon_setting['rt_icon_bar_setting'] ) == 'rselement_contact_box' ) {
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Topbar_Icon_List_Widget() );
		}

		require_once( __DIR__ . '/widgets/client-thumb/client-thumb.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacThemes_Client_Thumb_Showcase_Widget() );

		require_once( __DIR__ . '/widgets/timeline/timeline.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_timeline_Showcase_Widget() );

		require_once( __DIR__ . '/widgets/company-history/history.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_History_Showcase_Widget() );
		
		require_once( __DIR__ . '/widgets/woocommerce/cart.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Product_Cart() );

		require_once( __DIR__ . '/widgets/header-footer/site-search.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Search_Button() );


		require_once( __DIR__ . '/widgets/header-footer/site-canvas.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Offcanvas() );

		require_once( __DIR__ . '/widgets/header-footer/site-logo.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Site_Logo() );	

		require_once( __DIR__ . '/widgets/header-footer/site-nav.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Navigation_Menu() );	

		require_once( __DIR__ . '/widgets/header-footer/single-page-nav.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \RTS_Single_Navigation_Menu() );	

		require_once( __DIR__ . '/widgets/header-footer/copyright.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Elementor_Copyright_Widget() );

		require_once( __DIR__ . '/widgets/featured-image/image.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Featured_Image_Showcase_Widget() );	
		
		require_once( __DIR__ . '/widgets/portfolio-features-list/feature-list.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ReacTheme_Portfolio_Features_List_Widget() );
		
		require_once( __DIR__ . '/widgets/image-parallax/image.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Reactheme_Image_Parallax_Widget() );	
