...
class Color_Changer_Elementor_Admin {
    ...
    public function plugin_menu() {
        ...
        add_menu_page(__('RT Elementor Pages Color Changer','color-changer-elementor'), __('Openup Pages Color Changer','color-changer-elementor'), 
        ...
        add_submenu_page('ccel', 
            __('RT Elementor Pages Color Changer','color-changer-elementor'), 
            __('RT Elementor Pages Color Changer','color-changer-elementor'),
            'manage_options', 'ccel', array($this, 'admin_page_display'));
