...
class ReacTheme_Elementor_Counter_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
		    'number_width',
		    [
		        'label' => esc_html__( 'Number Width', 'rtelements' ),
		        'type' => Controls_Manager::SLIDER,		      
		        'selectors' => [
		            '{{WRAPPER}} .count-number' => 'width: {{SIZE}}{{UNIT}};',		          
		        ],
		    ]
		);
		...
		$this->add_control(
		    'number_height',
		    [
		        'label' => esc_html__( 'Number Height', 'rtelements' ),
		        'type' => Controls_Manager::SLIDER,		      
		        'selectors' => [
		            '{{WRAPPER}} .count-number' => 'height: {{SIZE}}{{UNIT}};',		          
		        ],
		    ]
		);
		...
		$this->add_control(
		    'number_line_height',
		    [
		        'label' => esc_html__( 'Number Line Height', 'rtelements' ),
		        'type' => Controls_Manager::SLIDER,		      
		        'selectors' => [
		            '{{WRAPPER}} .count-number' => 'line-height: {{SIZE}}{{UNIT}};',		          
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .count-number' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};', 
                ],	
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
					'{{WRAPPER}} .count-number' => 'text-align: {{VALUE}}'
				],                
			]
		);
