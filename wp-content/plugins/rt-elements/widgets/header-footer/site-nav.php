...
class RTS_Navigation_Menu extends Widget_Base {
	...
	protected function register_general_content_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Enable Menu Responsive Icon', 'rtelements' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'rtelements' ),
				'label_off' => esc_html__( 'No', 'rtelements' ),
				'return_value' => 'no',
		...
		$this->add_control(
			'seperator_on_click',
			[
				'label' => esc_html__( 'Enable Last Item Separator', 'rtelements' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'rtelements' ),
				'label_off' => esc_html__( 'No', 'rtelements' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'enable_right_icon',
			[
				'label' => esc_html__( 'Enable Right Icon', 'rtelements' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'rtelements' ),
				'label_off' => esc_html__( 'No', 'rtelements' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'enable_left_icon',
			[
				'label' => esc_html__( 'Enable Left Icon', 'rtelements' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'rtelements' ),
				'label_off' => esc_html__( 'No', 'rtelements' ),
				'return_value' => 'yes',
	...
	protected function register_style_content_controls() {
		...
		$this->start_controls_tabs( 'tabs_menu_item_style' );
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'default'   => '',
							'selectors' => [
								'{{WRAPPER}} .sticky-menu.menu-area .navbar ul li a' => 'color: {{VALUE}}',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .sticky-menu.menu-area .navbar ul li:hover > a,
								
								{{WRAPPER}} .sticky-menu.menu-area .navbar ul li.current-menu-item a' => 'color: {{VALUE}}',
							],
						]
					);					
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'default'   => '',
							'selectors' => [
								'{{WRAPPER}} .sticky-menu.menu-area .navbar ul li.current-menu-item a,
								{{WRAPPER}} .sticky-menu.menu-area .navbar ul li.current-menu-ancestor > a' => 'color: {{VALUE}}',
							],
						]
					);
			...
			$this->add_control(
				'sticky_color_bg',
				[
					'label'     => __( 'Sticky Area Bg Color', 'rtelements' ),
					'type'      => Controls_Manager::COLOR,
					'global'    => [
						'default' => Global_Colors::COLOR_TEXT,
					],
