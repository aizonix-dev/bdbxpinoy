	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .team-grid-style3 .team-item .team-content h3.team-name a:hover' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .team-grid-style3 .team-item .share-icon i' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .team-grid-style3 .team-item .share-icon li:hover i' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .team-grid-style3 .team-item .share-icon li:hover a' => 'background: {{VALUE}};',
                ],
                'separator' => 'before',                
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .team-grid-style1 .team-item .team-content' => 'text-align: {{VALUE}};',
				],
			]
		);
