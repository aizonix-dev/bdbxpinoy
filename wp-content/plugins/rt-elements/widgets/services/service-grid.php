...
class Reactheme_Elementor_Sservices_Grid_Widget extends \Elementor\Widget_Base {
	...
	public function get_style_depends() {
		...
		wp_register_style( 'rtelements-service-grid', plugins_url( 'css/service-grid.css', __FILE__ ) );
		
		return [
			'rtelements-service-grid'
		];
	 ...
	 */
		...
		$this->add_control(
			'service_box_batch',
			[
				'label'       => esc_html__( 'Batch Number', 'rtelements' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => '01',				
				'separator'   => 'before',
				'condition'	  => [
					'services_style' => ['style2', 'style4']
				]
			]
		);	
		...
		$this->add_control(
			...
			[
				...
				'condition' => ['services_style' => ['style3', 'style5']],
			]
		);
		...
		$this->add_control(
			...
			[	'label_block' => true,
				...
				'condition' => ['services_style' => ['style6', 'style5', 'style1', 'style2', 'style3', 'style4',]],		
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .react-addon-services.services-style1 .services-part',
			]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style1 .services-part' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .react-addon-services.services-style3 .services-part' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style1 .services-part' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .react-addon-services.services-style1 .services-part' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .react-addon-services .services-part',
			]
		);

		
		$this->add_control(
		    'service_box_border_hover_color',
		    [
		        'label' => esc_html__( 'Border Hover Color', 'rtelements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services .services-part:hover' => 'border-color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style1 .services-part' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .react-addon-services.services-style3 .services-part' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .react-addon-services.services-style1 .services-part',
				'selector' => '{{WRAPPER}} .react-addon-services.services-style3 .services-part'
		    ]
		);
		...
		$this->add_control(
            'box_hover_section',
            [
                'label' => esc_html__( 'Box Hover Style', 'rtelements' ),
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient', 'video' ],
				'selector' => '{{WRAPPER}} .react-addon-services.services-style1::after',
			]
		);
		...
		$this->start_controls_section(
		    '_section_box_style_number',
		    [
		        'label' => esc_html__( 'Number Style', 'rtelements' ),
		        'tab'   => Controls_Manager::TAB_STYLE,
		    ]
		);
		...
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
			[
				'name' => 'service_number_background',
				'types' => [ 'classic', 'gradient', 'video' ],
				'selector' => '{{WRAPPER}} .react-addon-services.services-style2 .services-part .batch-number',
			]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
					...
					'{{WRAPPER}} .services-icon svg' => 'width: {{SIZE}}{{UNIT}} !important;',
					'{{WRAPPER}} .services-icon svg' => 'height: {{SIZE}}{{UNIT}} !important;',
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style1 .services-icon' => 'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .react-addon-services.services-style3 .services-icon' => 'width: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style1 .services-icon' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .react-addon-services.services-style3 .services-icon' => 'height: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);	
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
					...
					'{{WRAPPER}} .react-addon-services.services-style3 .services-part .service-content .services-icon' => 'line-height: {{SIZE}}{{UNIT}} !important;',	
		        ],
		        'condition' => [
		            'icon_type' => 'icon'
		        ],
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .services-style3 .services-icon' => 'width: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		            'icon_type' => 'image'
		        ],
		...
		$this->add_responsive_control(
		    'image_height_box',
		    [
		        'label' => esc_html__( 'Image Box Height', 'rtelements' ),
		        'type' => Controls_Manager::SLIDER,
		        'size_units' => [ 'px', '%' ],
		        'range' => [
		            'px' => [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .services-style3 .services-icon' => 'height: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		            'icon_type' => 'image'
		        ],
		...
		$this->add_responsive_control(
		    'image_icon_width_box',
		    [
		        'label' => esc_html__( 'Image Outside Box Width', 'rtelements' ),
		        'type' => Controls_Manager::SLIDER,
		        'size_units' => [ 'px', '%' ],
		        'range' => [
		            'px' => [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style2 .services-part .service--top .icon-inner' => 'width: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		            'icon_type' => ['image'],
		        ],
		...
		$this->add_responsive_control(
		    'image_icon_height_box',
		    [
		        'label' => esc_html__( 'Image Outside Box Height', 'rtelements' ),
		        'type' => Controls_Manager::SLIDER,
		        'size_units' => [ 'px', '%' ],
		        'range' => [
		            'px' => [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style2 .services-part .service--top .icon-inner' => 'height: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		            'icon_type' => 'image'
		        ],
		...
		$this->add_control(
		    'image_border_color',
		    [
		        'label' => esc_html__( 'Image Outside Border Color', 'rtelements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style2 .services-part .service--top .icon-inner' => 'border-color: {{VALUE}} !important',
		        ],
		        'condition' => [
		            'icon_type' => 'image'
		        ],
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style2:hover .services-part .service--top .icon-inner' => 'border-color: {{VALUE}} !important',
		        ],
		        'condition' => [
		            'icon_type' => 'image'
		        ],
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .services-icon > img, {{WRAPPER}} .services-icon,{{WRAPPER}} .react-addon-services.services-style7 .single-work .service-img7' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
					...
					'{{WRAPPER}} .services-icon svg path' => 'fill: {{VALUE}} !important',
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services:hover .services-part .services-icon i' => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .react-addon-services:hover .services-part .services-icon svg path' => 'fill: {{VALUE}} !important',
		        ],
		        'condition' => [
		            'icon_type' => 'icon'
		        ]
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services:hover .services-icon' => 'background-color: {{VALUE}} !important',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        'label' => esc_html__( 'Thumbnail/Icon Border Color', 'rtelements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [		         
					'{{WRAPPER}} .react-addon-services.services-style4 .services-part .thumbnail' => 'border-color: {{VALUE}}',
		        ],
				'condition' => [
		...
		$this->add_control(
		    'number_icon_hover_bg_color',
		    [
		        'label' => esc_html__( 'Number Background Color', 'rtelements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [		         
		            '{{WRAPPER}} .react-addon-services.services-style3 .services-part .service--top .icon-inner .number' => 'background-color: {{VALUE}} !important',
					'{{WRAPPER}} .react-addon-services.services-style4 .services-part .thumbnail .batch-number' => 'background: {{VALUE}} !important',
		        ],
		    ]
		);
		...
		$this->add_control(
		    'number_border_color',
		    [
		        'label' => esc_html__( 'Number Border Color', 'rtelements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [		         
					'{{WRAPPER}} .react-addon-services.services-style4 .services-part .thumbnail .batch-number' => 'border-color: {{VALUE}} !important',
		        ],
				'condition' => [
		            'services_style' => 'style4',
		        ],
		...
		$this->add_control(
		    '_batch_styles',
		    [
		        'label' => esc_html__( 'Image Batch Syles', 'rtelements' ),
		        'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition'	  => [
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style2 .rts-single-service-inner .services-image .img-batch span' => 'color: {{VALUE}}',
		        ],
				'condition'	  => [
					'services_style' => 'style2'
				]
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style2 .rts-single-service-inner .services-image .img-batch span' => 'background: {{VALUE}}',
		        ],
				'condition'	  => [
					'services_style' => 'style2'
				]
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style2 .rts-single-service-inner .services-image .img-batch span' => 'height: {{SIZE}}{{UNIT}};',
		        ],
				'condition'	  => [
					'services_style' => 'style2'
				]
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style2 .rts-single-service-inner .services-image .img-batch span' => 'width: {{SIZE}}{{UNIT}};',
		        ],
				'condition'	  => [
					'services_style' => 'style2'
				]
		...
		$this->add_responsive_control(
		    'content_margin',
		    [
		        'label' => esc_html__( 'Content Box Margin', 'rtelements' ),
		        'type' => Controls_Manager::DIMENSIONS,
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		    ...
		    [
		        ...
		        'selectors' => [
					...
					{{WRAPPER}}  .react-addon-services .single-work h5 a' => 'color: {{VALUE}}',
		             '{{WRAPPER}} .react-addon-services .services-part .services-text .services-title .title,
					  {{WRAPPER}} .react-addon-services .services-part .services-title .title,
					  {{WRAPPER}}  .react-addon-services .services-part .services-text .services-title .title a' => 'color: {{VALUE}}',
					  '{{WRAPPER}} .react-addon-services.services-style10 .rts-single-process-wrapper-eight .title' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
					...
					'{{WRAPPER}} .react-addon-services.services-style10 .rts-single-process-wrapper-eight .title:hover' => 'color: {{VALUE}}',
		...
		$this->add_group_control(
		    Group_Control_Typography::get_type(),
		    [
		        'name' => 'srv10_title_typography',
		        'label' => esc_html__( 'Typography', 'rtelements' ),
		        'selector' => '{{WRAPPER}} .react-addon-services.services-style10 .rts-single-process-wrapper-eight .title',
		        'scheme' => Elementor\Core\Schemes\Typography::TYPOGRAPHY_2,
		        'condition' => ['services_style' => [ 'style10']],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '{{WRAPPER}} .services-text p' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
					...
					'{{WRAPPER}} .react-addon-services.services-style2 .rts-single-service-inner .service-content .services-btn-part .services-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services .services-part .services-btn-part .services-btn, .services-btn-part .services-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '{{WRAPPER}} .react-addon-services .services-btn-part .services-btn' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .elementor-widget-container:hover .react-addon-services .services-part .services-btn-part .services-btn,
					 {{WRAPPER}} .elementor-widget-container:hover .react-addon-services .services-part .services-btn-part:focus .services-btn',
		            '{{WRAPPER}}  .react-addon-services .services-part .product-box .go-btn:hover, 
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            //'{{WRAPPER}} .elementor-widget-container:hover .react-addon-services .services-part .services-btn-part .services-btn, 
					//{{WRAPPER}} .elementor-widget-container:hover .react-addon-services .services-part:focus .services-btn-part .services-btn' => 'background-color: {{VALUE}};',
		...
		$this->add_control(
		    'button_icon_color',
		    [
		        'label' => esc_html__( 'Button Icon Color', 'rtelements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [		           
					'{{WRAPPER}} .react-addon-services.services-style1 .services-btn-part a i' => 'color: {{VALUE}};',
		...
		$this->add_control(
		    'button_icon_bg',
		    [
		        'label' => esc_html__( 'Button Icon Bg Color', 'rtelements' ),
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [		           
					'{{WRAPPER}} .react-addon-services.services-style1 .services-btn-part a i' => 'background: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style1 .services-btn-part a i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style1 .services-btn-part a i' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .react-addon-services.services-style1 .services-btn-part a i' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
	}
	...
	protected function render() {
		...
		if('style2' == $settings['services_style']){
		...
		elseif('style4' == $settings['services_style']){
