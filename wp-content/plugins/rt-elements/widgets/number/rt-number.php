...
class ReacThemes_Elementor_Numnber_Widgets extends \Elementor\Widget_Base {
	 ...
	 */
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .rts-addon-number .number-part' => 'text-align: {{VALUE}}'
                ],
				'separator' => 'before',
            ]
        );
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn.icon-before i' => 'margin-right: {{SIZE}}{{UNIT}};',
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn.icon-after i' => 'margin-left: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-area:before',
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}}  .rts-addon-number .number-part .number-text .number-prefix',
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-area' => 'width: {{SIZE}}{{UNIT}} !important;',
		        ],
		        'condition' => [
		            'title_prefix' => 'block'
		        ],
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-area' => 'height: {{SIZE}}{{UNIT}} !important;',
		        ],
		        'condition' => [
		            'title_prefix' => 'block'
		        ],
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-area:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-area' => 'left: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number:hover .number-part .number-text .number-area' => 'left: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-area' => 'top: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number:hover .number-part .number-text .number-area' => 'top: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-area' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		        'condition' => [
		            'title_prefix' => 'block'
		        ],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
				    '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-prefix' => 'color: {{VALUE}}',
				],
		        'condition' => [
		            'title_prefix' => 'block'
		        ],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
				    '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-area:before' => 'background: {{VALUE}}',
				],
		        'condition' => [
		            'title_prefix' => 'block'
		        ],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
				    '{{WRAPPER}} .rts-addon-number:hover .number-part .number-text .number-area:before' => 'border-color: {{VALUE}}',
				],
		        'condition' => [
		            'title_prefix' => 'block'
		        ],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
				    '{{WRAPPER}} .rts-addon-number:hover .number-part .number-text .number-prefix' => 'color: {{VALUE}}',
				],
		        'condition' => [
		            'title_prefix' => 'block'
		        ],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
				    '{{WRAPPER}} .rts-addon-number:hover .number-part .number-text .number-area:before' => 'background: {{VALUE}}',
				],
		        'condition' => [
		            'title_prefix' => 'block'
		        ],
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'default' => 'none',
                'selectors' => [
                    '{{WRAPPER}} .rts-addon-number .number-part::after' => 'display: {{VALUE}};',
                ],
		    ]
		);			
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'default' => 'unset',
                'selectors' => [
                    '{{WRAPPER}} .rts-addon-number .number-part::after' => 'width: {{VALUE}};',
                ],
		        'condition' => [
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part::after' => 'width: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '(desktop){{WRAPPER}} .rts-addon-number .number-part::after' => '-ms-transform: translate({{border_offset_x.SIZE}}{{UNIT}}, {{border_offset_y.SIZE}}{{UNIT}}); -webkit-transform: translate({{border_offset_x.SIZE}}{{UNIT}}, {{border_offset_y.SIZE}}{{UNIT}}); transform: translate({{border_offset_x.SIZE}}{{UNIT}}, {{border_offset_y.SIZE}}{{UNIT}});',
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part::after' => 'height: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		            'content_bottom_border' => 'block',
		        ],
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part::after' => 'left: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		            'content_bottom_border' => 'block',
		        ],
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part::after' => 'background:  {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => ['px'],
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-title .title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-title .title, {{WRAPPER}}  .rts-addon-number .number-part .number-text .number-title .title a' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part:hover .number-text .number-title .title, {{WRAPPER}}  .rts-addon-number .number-part:hover .number-text .number-title .title a' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'label' => esc_html__( 'Typography', 'rsaddon' ),
		        'selector' => '{{WRAPPER}}  .rts-addon-number .number-part .number-title .title',
		        'scheme' => Elementor\Core\Schemes\Typography::TYPOGRAPHY_2
		    ]
		);		
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => ['px'],
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-txt' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-txt' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part:hover .number-text .number-txt' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'label' => esc_html__( 'Typography', 'rsaddon' ),
		        'selector' => '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-txt',
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        'name' => 'btn_typography',
		        'selector' => '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn',
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '',
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn' => 'color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn.icon-before i' => '-webkit-transform: translateX(calc(-1 * {{SIZE}}{{UNIT}})); transform: translateX(calc(-1 * {{SIZE}}{{UNIT}}));',
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn.icon-after i' => '-webkit-transform: translateX({{SIZE}}{{UNIT}}); transform: translateX({{SIZE}}{{UNIT}});',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part:hover .number-text .number-btn-part .number-btn, {{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part:focus .number-btn' => 'color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part:hover .number-text .number-btn-part .number-btn, {{WRAPPER}} .rts-addon-number .number-part:focus .number-text .number-btn-part .number-btn' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn:hover, {{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn:focus' => 'border-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn.icon-before:hover i' => '-webkit-transform: translateX(calc(-1 * {{SIZE}}{{UNIT}})); transform: translateX(calc(-1 * {{SIZE}}{{UNIT}}));',
		            '{{WRAPPER}} .rts-addon-number .number-part .number-text .number-btn-part .number-btn.icon-after:hover i' => '-webkit-transform: translateX({{SIZE}}{{UNIT}}); transform: translateX({{SIZE}}{{UNIT}});',
		        ],
		    ]
		);
	...
	protected function render() {
		...
		?>			
		<div class="rts-addon-number number">
