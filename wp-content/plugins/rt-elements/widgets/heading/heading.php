...
class Reactheme_Elementor_Heading_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'enable_border',
			[
				'label' => esc_html__( 'Enable Title Bottom Border', 'rtelements' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'rtelements' ),
				'label_off' => esc_html__( 'No', 'rtelements' ),
				'return_value' => 'yes',
        ...
        $this->add_group_control(
			...
			[
				'name' => 'background_normal_hight',
				'label' => esc_html__( 'Title Highlight Background', 'rsaddon' ),
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .react-heading .title-inner .title .high_light_text',
			]
		);
		...
		$this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Hight Light Title', 'rtelements' ),
                'separator' => 'before',
            ]
        );
		...
		$this->add_control(
            'title_stroke_section',
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Title Stroke Style', 'rtelements' ),
                'separator' => 'before',
				'condition' => [
					'enable_stroke' => 'yes'
				]
		...
		$this->add_control(
            'title_stroke_color',
            [
                'label' => esc_html__( 'Stroke Color', 'rtelements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .react-heading .title-inner.yes .title' => '-webkit-text-stroke: 1px {{VALUE}};',
                ],  
				'condition' => [
					'enable_stroke' => 'yes'
				]              
		...
		$this->add_control(
            'title_strokefill_color',
            [
                'label' => esc_html__( 'Stroke Fill Color', 'rtelements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .react-heading .title-inner.yes .title' => '-webkit-text-fill-color: {{VALUE}};',
                ], 
				'condition' => [
					'enable_stroke' => 'yes'
				]               
		...
		$this->add_control(
            'subtitle_highlight_bgcolor',
            [
                'label' => esc_html__( 'Subtitle Highlight Color', 'rtelements' ),
                // 'desc' => esc_html__( 'Add span tag to apply background style', 'rtelements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .react-heading .title-inner .sub-text span' => 'color: {{VALUE}};',
                ],                
            ]
        );
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .react-heading .title-inner .sub-text span',
			]
		);
		
		$this->add_responsive_control(
            'subtitle_highlight_text_border_radius',
            [
                'label' => esc_html__( 'High light Border Radius', 'rtelements' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .react-heading .title-inner .sub-text span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_responsive_control(
            'subtitle_padding',
            [
                'label' => esc_html__( 'Subtitle Padding', 'rtelements' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
					'{{WRAPPER}} .react-heading .title-inner .sub-text span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->end_controls_section();
			...
			$this->start_controls_section(
				...
				$this->start_controls_section(
					...
					[
						'label' => esc_html__( 'AOS Animation', 'rtelements' ),
						'tab'   => Controls_Manager::TAB_STYLE,
					]
				);
				$this->add_control(
					'enable_animation',
					[
						'label' => esc_html__( 'Enable Animation', 'textdomain' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
				...
				$this->add_control(
					...
					[
						...
						'options' => [
							...
							'slide-down'  => esc_html__( 'Slide Down', 'textdomain' ),
							'slide-left' => esc_html__( 'Slide Left', 'textdomain' ),
							'slide-right' => esc_html__( 'Slide Right', 'textdomain' ),
				...
				$this->add_control(
					'data_delay',
					[
						'label' => esc_html__( 'Data Delay', 'rtelements' ),
						'type' => Controls_Manager::TEXT,
						'default' => esc_html__( '150', 'rtelements' ),
						'condition' =>[
							'enable_animation' =>  'yes'
						]
				...
				$this->add_control(
					'data_duration',
					[
						'label' => esc_html__( 'Data Duration', 'rtelements' ),
						'type' => Controls_Manager::TEXT,
						'default' => esc_html__( '800', 'rtelements' ),
						'condition' =>[
							'enable_animation' =>  'yes'
						]
					]
	...
	protected function render() {
		...
		if($settings['enable_animation'] == 'yes'){
			$animate_img = 'data-aos-delay="100" data-aos="fade-up" data-aos-duration="800" data-aos-once="true"';
            $animate = 'data-aos-delay="300" data-aos="fade-up" data-aos-duration="800" data-aos-once="true"';
			$animate_sub = 'data-aos-delay="200" data-aos="fade-up" data-aos-duration="800" data-aos-once="true"';
			$animate_des = 'data-aos-delay="350" data-aos="fade-up" data-aos-duration="800" data-aos-once="true"';
      ...
      ?>
        ...
        <div class="react-heading <?php echo esc_attr($settings['style']);?> <?php echo esc_attr($settings['align']);?> title-border-<?php echo $settings['enable_border'];?>">
