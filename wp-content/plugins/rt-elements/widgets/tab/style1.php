<div class="rts-tab-style-one">
    <div class="d-flex align-items-start contoler-company">
        <div class="nav flex-column nav-pills me-3 button-area" id="v-pills-tab" role="tablist" aria-orientation="<?php echo $settings['type'];?>">
            <?php
            ...
            <?php
                ...
                foreach ( $tabs as $index => $item ) :
                    ...
                    <div class="rts-tab-content-one">
                        ...
                        <a class="rts-btn btn-primary-2 color-h-black" href="<?php echo esc_url($item['link']['url']);?>" <?php echo esc_attr($target);?>><?php echo $item['btn_text'];?></a>
                    </div>
