            ...
            <div class="portfolio-content">
                <div class="content-inner">
                    <div class="content-text">
                    	...
                    	<?php endif;?>	
						<?php if(!empty($settings['p-short-des'])) : ?>	
							<p class="p-short-des">
								<?php echo wp_kses_post($settings['p-short-des']); ?>
							</p>
						<?php endif; ?>
						<?php if(!empty($settings['p-short-btn'])) : ?>	
							<a class="p-short-btn" href="<?php echo esc_url($settings['p-short-btn-url']['url']); ?>"><?php echo wp_kses_post($settings['p-short-btn']); ?></a>
						<?php endif; ?>
                    </div>
