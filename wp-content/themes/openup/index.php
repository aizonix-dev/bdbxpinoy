...
<div id="reactheme-blog" class="reactheme-blog blog-page">
   <?php
    ...
    if(!empty($openup_option['blog-layout']) || !is_active_sidebar( 'sidebar-1' )){

        $blog_layout = !empty($openup_option['blog-layout']) ? $openup_option['blog-layout'] : '';
        $blog_grid   =  !empty($openup_option['blog-grid']) ? $openup_option['blog-grid'] : '';
                                ...
                                <div class="full-blog-content">
                                    <div class="user-info">
                                        ...
                                        <div class="single-info">
                                            ...
                                            <span>  <?php echo esc_html__('by', 'openup');?>  
                                                <?php if(!empty($openup_option['blog-author-post'])){
                                                if ($openup_option['blog-author-post'] == 'show'): 
                                        ...
                                        <div class="single-info cat">
                                            ...
                                            <span> <?php if(!empty($openup_option['blog-category'])){
                                                if($openup_option['blog-category'] == 'show'){
                                                    if(get_the_category()):
                                                        the_category(', ');                                                 
                                                endif;
                                                    }
                                    ...
                                    <div class="blog-desc">   
                                        <?php echo openup_custom_excerpt(30);?>                                     
                                    </div>                                     
                                    <?php                                     
                                          
                                        if(!empty($openup_option['blog_readmore'])):?>
                                            <div class="blog-button">
                                                <a href="<?php the_permalink();?>">
                                                    <?php echo esc_html($openup_option['blog_readmore']); ?>
                                                </a>
                                            </div>
                                    <?php endif; ?>
                            </div>
