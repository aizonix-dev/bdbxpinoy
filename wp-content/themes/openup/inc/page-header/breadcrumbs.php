...
<?php 
  ...
  if($post_meta_data == ''){
    if(!empty($openup_option['page_banner_main']['url'])):
      $post_meta_data = $openup_option['page_banner_main']['url'];
    
    else: {
      $post_meta_data2 = !empty($openup_option['breadcrumb_bg_color'])? $openup_option['breadcrumb_bg_color'] : '';
    }
    endif;
  }  
